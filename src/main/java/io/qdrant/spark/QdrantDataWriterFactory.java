...
/**
 * Factory class for creating QdrantDataWriter instances for Spark Structured
 * Streaming.
 */
public class QdrantDataWriterFactory implements StreamingDataWriterFactory, DataWriterFactory {
     ...
     * 
     * @param options QdrantOptions instance containing configuration options for
     *                Qdrant.
     * @param schema  StructType instance containing schema information for the data
     *                being written.
     */
